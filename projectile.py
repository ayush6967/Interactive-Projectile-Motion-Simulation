...
k = float(input("Enter air resistance coefficient (suggested range 0.001 to 0.1 for realistic results): "))
...
print(f"Without drag — Time of Flight: {t_without_drag:.2f} sec")
print(f"With drag    — Time of Flight: {t_with_drag:.2f} sec")
